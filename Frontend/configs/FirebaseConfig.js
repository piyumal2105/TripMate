...
import { getFirestore, collection, addDoc,doc,updateDoc,increment} from "firebase/firestore"; // Ensure 'collection' is imported
import { onSnapshot } from "firebase/firestore";  // Import onSnapshot correctly
